...
export function BangkokPattaya() {
  const tourDetails = {
    ...
    rating: 5,
    reviews: 156,
    image: 'https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=1080',
  ...
  const included = [
    ...
    'Bangkok 2 Gece + Pattaya 5 Gece Oda Kahvaltı Konaklamalar',
  ...
  const notIncluded = [
    ...
    'Kişisel harcamalar',
    'Extra Turlar (Bangkok Kanallar, Baiyoke Sky, Yüzen Çarşı, vb.)',
    'Öğle ve akşam yemekleri',
    'Vize işlemleri (Tayland vizesi giriş ücreti)'
  ];
  ...
  const program = [
    ...
    {
      day: 5,
      title: 'Pattaya Serbest Gün - Mercan Adası',
      description: 'Sabah kahvaltımızın ardından serbest zaman. Arzu eden misafirlerimiz extra olarak düzenlenecek MERCAN KAYALIKLARI ile ünlü MERCAN ADASI Turu (50 EUR) katılabilirler. Sinirsiz güneş ve okyanus keyfi... Pattaya sahilinden özel sürat teknelerimizle, palmiye ağaçları arasında mercan tozlarından oluşmuş beyaz kumsalı ile bütün gün turkuaz sularında yüzebileceğimiz Mercan adasına gidiyoruz.',
      images: ['https://images.unsplash.com/photo-1537956965359-7573183d1f57?w=800']
    },
    {
      day: 6,
      title: 'Pattaya Serbest Gün - Nong Nooch',
      description: 'Sabah kahvaltımızın ardından serbest zaman. Dileyen misafirlerimiz extra olarak düzenlenecek olan Nong Nooch Tropical Garden Turu (35 EUR) katılabilirler. Tayland\'da yıllarca en iyi düzenlenmiş bahçe ödülü alan bu muazzam tropik bahçede çok sayıda fotoğraf çekeceğinizi garanti ediyoruz. Tay kültürünü yakından tanıyacağımız kültürel şov, Tay Boksu gösterisi, fillerin yaptıkları harika gösteri.',
      images: ['https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=800']
    },
    {
      day: 7,
      title: 'Pattaya Serbest Gün',
      description: 'Sabah kahvaltımızın ardından serbest zaman. Pattaya\'nın güzel plajlarında dinlenme, alışveriş veya isteğe bağlı aktivitelerde bulunma günü. Geceleme Otelimizde.',
      images: ['https://images.unsplash.com/photo-1598466259189-534a05c874be?w=800']
    },
    {
      day: 8,
      title: 'Pattaya Serbest Gün',
      description: 'Sabah kahvaltımızın ardından serbest zaman. Son gününüzü istediğiniz gibi değerlendirebilir, plajın keyfini çıkarabilir veya şehri daha fazla keşfedebilirsiniz. Geceleme Otelimizde.',
      images: ['https://images.unsplash.com/photo-1559628376-f3fe5f782a2e?w=800']
    },
    {
      day: 9,
      title: 'Pattaya - Bangkok - Tahran - İstanbul',
  ...
  const highlights = [
    ...
    '2 Gece Bangkok + 5 Gece Pattaya konaklaması',
    'Oda kahvaltı konaklama',
    'Tüm havalimanı transferleri dahil',
    'Profesyonel rehberlik hizmeti',
    'Egzotik Uzakdoğu deneyimi'
  ];

  const extraTours = [
    { name: 'Bangkok Kanallar Turu', price: '25 EUR' },
    { name: 'Baiyoke Sky & Asiatique Riverfront Turu', price: '50 EUR' },
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">7 Gece Oda Kahvaltı</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
